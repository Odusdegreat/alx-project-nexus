...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    description:
      "Elegant set of 4 ceramic coffee mugs perfect for home or office use.",
    price: 49.99,
    image: "https://m.media-amazon.com/images/I/61qNllUllPL._AC_SL1500_.jpg",
  ...
  },
  {
    ...
    description:
      "Portable Bluetooth speaker with crystal clear sound and 12-hour battery life.",
    price: 79.99,
    originalPrice: 99.99,
    image:
  ...
  },
  {
    ...
    name: "Running Shoes",
    description:
      "Comfortable running shoes with advanced cushioning and breathable mesh.",
    price: 119.99,
  ...
  },
  {
    ...
    description:
      "Professional kitchen knife set with cutting board and storage block.",
    price: 129.99,
    originalPrice: 179.99,
    image:
      "https://media.istockphoto.com/id/2162031758/photo/casting-steel-various-chef-knife-set-of-modern-sharp-kitchen-knives-on-dark-background.webp?a=1&b=1&s=612x612&w=0&k=20&c=m_hjwr66lN8D_ctO0wCsJfSndwYEGIfrp7hxDjQpU4M=",
    category: "Home & Kitchen",
    rating: 4.9,
    reviewCount: 356,
    inStock: true,
